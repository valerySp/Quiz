...
public class level5 extends AppCompatActivity {
    ...
    public int count=0;
    public final int lvl=50;
    public final double div=2.5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View layout_left=findViewById(R.id.line5_univ);
        final View layout_right=findViewById(R.id.line6_univ);
        layout_left.setClipToOutline(true);
        layout_right.setClipToOutline(true);
        ...
        textEnd.setText(R.string.level5End);
